...
cyto_prefix = '2017-01-23_musc_81x81_100imgs_20170123_musc_81x81_' # prefix of network weight filenames
...
for j in range(nb_networks):
    cyto_weights = os.path.join(trained_network_dir, cyto_prefix + str(j) + ".h5")
