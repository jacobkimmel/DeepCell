...
def get_image(file_name, invert=False):
    '''
    Wrapper for image reader libraries
    ...
    invert : boolean, optional.
        Determines whether the image is inverted on reading.
        Useful when loading binary TIFFs, as the Python libraries read them
        as inverted due to a lack of metadata handling.
        Default = False.
...
def train_model_sample(model = None, dataset = None,  optimizer = None,
    ...
    rotate = True, flip = True, shear = 0, class_weight = None, early_stopping=None):
    ...
    if early_stopping == True:
        callbacks.append(EarlyStopping(monitor='val_acc', patience=3))
